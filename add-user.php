  ...
  <?php 
    ...
    if(isset($_POST['save'])){
      ...
      if($valid == 1){
        ...
        $stmt = $conn->prepare("INSERT INTO users (first_name, last_name, email, password, status, created_at) VALUES (?,?,?,?,?,?)");
        //execute the query
        $run  = $stmt->execute(array($first_name, $last_name, $email, md5($password), $status, $date_created));
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="first_name" placeholder="Enter First Name" name="first_name" >
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
                            <label for="last_name">Last Name</label>
                            <input type="text" class="form-control form-control-user" id="last_name" placeholder="Enter Last Name" name="last_name">
                          </div>
                        </div>
                        <div class="col-lg-6">
                          <div class="form-group">
